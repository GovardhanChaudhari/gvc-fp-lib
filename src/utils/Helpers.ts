...
export const createIfFunc = R.curry((func, pred, value, name, obj) => {
  ...
  return isPredicateTrue(pred, value, name, obj) ? func(value, name, obj) : obj;
});
...
export const createNamesReduceFuncIf = createIteratorIfFunc(
...
export const createObjectsMapFuncIf = createIteratorIfFunc(
